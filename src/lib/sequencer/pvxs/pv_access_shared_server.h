...
#ifndef SUP_SEQUENCER_PLUGIN_EPICS_PV_ACCESS_SHARED_SERVER_H_
#define SUP_SEQUENCER_PLUGIN_EPICS_PV_ACCESS_SHARED_SERVER_H_
...
#endif  // SUP_SEQUENCER_PLUGIN_EPICS_PV_ACCESS_SHARED_SERVER_H_
