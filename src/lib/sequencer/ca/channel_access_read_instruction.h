...
#ifndef SUP_SEQUENCER_PLUGIN_EPICS_CHANNEL_ACCESS_READ_INSTRUCTION_H_
#define SUP_SEQUENCER_PLUGIN_EPICS_CHANNEL_ACCESS_READ_INSTRUCTION_H_
...
#endif  // SUP_SEQUENCER_PLUGIN_EPICS_CHANNEL_ACCESS_READ_INSTRUCTION_H_
